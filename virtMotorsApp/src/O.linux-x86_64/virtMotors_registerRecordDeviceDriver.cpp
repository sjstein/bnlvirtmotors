...
/* Generated from ../O.Common/virtMotors.dbd */
...
static const char * const recordTypeNames[] = {
    ...
    "mbbo", "mbboDirect", "motor", "permissive", "printf", "sel", "seq",
    "state", "stringin", "stringout", "sub", "subArray", "waveform"
};
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devMbboDirectSoftCallback, *pvar_dset_devMotorAsyn,
    *pvar_dset_devMotorSoft, *pvar_dset_devPrintfSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devLiSoftCallback", "devLiGeneralTime", "devLoSoft",
    ...
    "devMbboDirectSoftCallback", "devMotorAsyn", "devMotorSoft",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devMotorAsyn, pvar_dset_devMotorSoft,
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    pvar_func_asynMotorControllerRegister, pvar_func_dbndInitialize,
    pvar_func_decInitialize, pvar_func_motorRegister,
...
int virtMotors_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/epics/iocs/virtmotors";
...
/* virtMotors_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"virtMotors_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(virtMotors_registerRecordDeviceDriver(*iocshPpdbbase));
}
