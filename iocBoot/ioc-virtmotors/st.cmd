...
< envPaths
# Below may not be needed for local instance
...
#epicsEnvSet("ENGY",      "EnergyMotor")
epicsEnvSet("BRAGGMTR",  "XF:19IDC-OP{Mono:DCM-Ax:B}Mtr")
#epicsEnvSet("BRAGGMTR",  "IOC:m4")
epicsEnvSet("PERPMTR",   "PerpMotor")
epicsEnvSet("PARAMTR",   "ParaMotor")
